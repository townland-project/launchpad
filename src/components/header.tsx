...
export const Header = () => {
    return (
        <header className="pl-14 pr-14 w-full flex flex-col absolute top-0">
            <div className="pt-6 flex flex-nowrap items-center justify-end">
                {
            ...
            <div className="flex flex-nowrap items-center pt-6">
                <a className="flex flex-nowrap items-center" href="https://townland.xyz">
                    ...
                    <div className="flex flex-col ml-[10px]">
                        <strong className="text-slate-600 text-xl">Townland</strong>
...

                {
                    HeaderLinks.slice(0, HeaderLinks.length).map((link, index) =>
                        <a
                            className="mr-2 h-10 px-6 rounded-md text-slate-500 hover:bg-slate-50 flex items-center justify-center"
                            key={index}
                            href={`https://townland.xyz${link.path}`}>
                            {link.name}
                        </a>
                ...
                <button className="h-10 px-6 rounded-md bg-amber-500 text-white drop-shadow-[0_6px_#d97706] flex items-center justify-center">
                    Login Account
                </button>
            </div>
        </header>
